		...
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="register/add" method="POST">
					...
					<dl>
						<dt>验证码</dt>
						<dd><input type="text" name="smscode" class="text" size="10" style="width:58px;"/>
							<input type="button" id="getsmscode" value="获取验证码"></input>
						</dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
						<dd><input type="submit" value="立即注册" class="submit" onsubmit="isNotNull()"/> <input type= "checkbox" checked="checked"/>阅读并同意<a href="" class="forget">服务协议</a></dd>
					</dl>
				</form>
