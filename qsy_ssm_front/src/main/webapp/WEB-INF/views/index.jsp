		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="http://localhost:8083/front/index">ShopCZ商城</a></b>[<a href="http://localhost:8084/login/tologin">登录</a>][<a href="http://localhost:8089/register/show">注册</a>]</p>
				</div>
			...
			<div class="shop_hd_menu_all_category shop_hd_menu_hover"><!-- 首页去掉 id="shop_hd_menu_all_category" 加上clsss shop_hd_menu_hover -->
				...
				<div id="shop_hd_menu_all_category_hd" class="shop_hd_menu_all_category_hd">
					<ul class="shop_hd_menu_all_category_hd_menu clearfix" id ="shop_menu">
						<!-- 单个菜单项 -->
						<%-- <c:forEach items="${NodeLists}" var="cateNode">
						<li id="cat_1" class="">
							<h3><a href="" title="${cateNode.name}">${cateNode.name}</a></h3>
							<div id="cat_1_menu" class="cat_menu clearfix" style="">
								<c:forEach items="${cateNode.children}" var="children">
								<dl class="clearfix">
									<dt><a href="${children.name}" href="">${children.name}</a></dt>
									<c:forEach items="${children.children}" var="son">
									<dd>
										<a href="">${son.name}</a>
									</dd>
									</c:forEach>
            ...
            <div class="shop_bd_top clearfix">
                ...
                <div class="shop_bd_top_right clearfix">
                    <div class="shop_bd_top_right_quickLink">
                        <a href="http://localhost:8084/login/tologin" class="login" title="会员登录"><i></i>会员登录</a>
                        <a href="http://localhost:8089/register/show" class="register" title="免费注册"><i></i>免费注册</a>
