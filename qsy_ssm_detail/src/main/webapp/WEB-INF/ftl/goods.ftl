	...
	<div class="shop_goods_bd clear">
		...
		<div class="shop_goods_show">
			<div class="shop_goods_show_left">
				...
				<div id="preview">
					<div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="${product.images}" jqimg="${product.images}" width="350">
						</div>
						<div id="spec-n5">
			...
			<div class="shop_goods_show_right">
				<ul>
					...
					<li style="padding:20px 0;">
						<label>&nbsp;</label>
						<span><a href="" class="goods_sub goods_sub_gou" pro_id="${product.id}" >加入购物车</a></span>
					</li>
				</ul>
			</div>
		</div>
